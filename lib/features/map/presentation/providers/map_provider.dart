...
class MapState {
  ...
  MapState({required this.points, required this.routePolyline, this.selectedPoint});
  ...
  MapState copyWith({
    ...
    return MapState(
      ...
      selectedPoint: clearSelection ? null : (selectedPoint ?? this.selectedPoint),
    );
  }
}
    ...
    return MapState(
      points: [
        MapPoint(
          id: '1', 
          name: 'Taller de Nury', 
          description: 'Artesanía textil en lana de oveja con tintes naturales de la zona. Conoce el proceso del Witral.',
          imageUrl: 'https://images.unsplash.com/photo-1590736962236-407a505f9630',
          phone: '+56912345678',
        ...
        MapPoint(
          id: '2', 
          name: 'Ruka de Rosa', 
          description: 'Gastronomía Mapuche tradicional. Prueba el pan de piñón y el muday en un ambiente ancestral.',
          imageUrl: 'https://images.unsplash.com/photo-1596230529625-7ee10f7b09b6',
          phone: '+56987654321',
        ...
        MapPoint(
          ...
          description: 'Alojamiento sustentable con vista al Villarrica. Energía solar y gestión de residuos zero waste.',
